	...
	<body>
		<nav class = "navbar navbar-default navbar-fixed-top" id ="my-navbar">
	   	...
	   	<div class="jumbotron" id="search">
	      	...
	      	<div class="container text-center">
	      		...
	      		<div class="row">
				  	<form action="search2.0.0.php" method="post">
					  	<div class="col-lg-6">
		...
		<table class="table" width='70%'>
			...
			<tr>
				...
				<td align='center'>
					<img src="vs.png" height='200px' width='200px'>
				</td>
				...
				<td>
					<div class="progress">
						<div class="progress-bar progress-bar-info progress-bar-striped" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 40%">
					  	...
					  	<div div class="progress-bar progress-bar-success progress-bar-striped" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 60%">
